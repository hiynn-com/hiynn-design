...
<HdCheckboxBar options={this.state.options} onChange={this.onChange}/>
<HdCheckboxBar url={this.state.url} onChange={this.onChange}/>`,
      options: [
        {icon: '#1496f1', name: '柳工', value: '0'},
        {icon: '#10a950', name: '成团', value: '1', checked: true},
        {icon: '#d8c01e', name: '柳江', value: '2', checked: true},
      ...
      url: 'http://yapi.demo.qunar.com/mock/11526/getCheckboxBarOptions',
    };
  }
    ...
    return (
      <PreviewLayout>
        ...
        <CodePreviewer code={this.state.code} showCode>
          ...
          <button onClick={() => {
            this.setState({
              options: [...this.state.options, {icon: '#000', name: '测试', value: `${Math.random()}`}],
            });
          }}
          >Change Options
          </button>
