      ...
      <div>
        <PreviewLayout>
          ...
          <CodePreviewer code={example} showCode={true}>
            <SearchForm searchFormOption={searchFormOption} wrappedComponentRef={form => (this.searchFormRef = form)} handleChange={this.handleChange} handleAdd={this.handleAdd} layout="inline" />
          </CodePreviewer>
