...
export default class DatePickerPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      <HdDatePicker label={"日期选择"} onOk={this.onOk} onChange={this.onChange} size={"small"}></HdDatePicker>
          
      <HdDatePicker label={"日期选择"} onOk={this.onOk} onChange={this.onChange}></HdDatePicker>
      `,
      code2: `
      import { HdDatePicker } from 'hiynn-design';
      import moment from "moment";
      ...
      <HdDatePicker label={"日期时间选择"} onOk={this.onOk} showTime={{ format: "HH:mm" }} onChange={this.onChange}></HdDatePicker>
      `,
      code3: `
      import { HdDatePicker } from 'hiynn-design';
      import moment from "moment";
